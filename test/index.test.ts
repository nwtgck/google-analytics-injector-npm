...
describe('injectedHtml', () => {
  it('should inject tracking ID into HTML with <head>', () => {
    const html1 =
`<html>
<head>
  <title>My HTML</title>
...
<body>
  ...
  it('should inject tracking ID into HTML with <head> but without <html>', () => {
    const html1 =
`<head>
  <title>My HTML</title>
</head>
...
<body>
  ...
  it('should inject tracking ID into HTML without <head>', () => {
    const html1 =
`<!-- myfile.html -->
<body>
  <h1>My File</h1>
